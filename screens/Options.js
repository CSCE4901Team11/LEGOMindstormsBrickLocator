        ...
        <View style={styles.space}>
          <View>
            ...
            <Modal isVisible={isModalVisible}>
              <View style={{ margin: 0 }}>
                <Text style={{backgroundColor: colors.background, color: colors.textColor, borderRadius: 20, padding: 35, alignItems: "center", 
                ...
                <TouchableOpacity onPress={toggleModal}>
                  <Text style={[styles.buttonClose, {backgroundColor: colors.background, color: colors.textColor}]} >Close</Text>
                </TouchableOpacity>
              </View>
            </Modal>
          </View>
