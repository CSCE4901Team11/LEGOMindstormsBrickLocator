...
function ThemesScreen () {
  ...
  const darkThemeChange = ()  => {
    ...
    return (
         ...
         <View>
        <TouchableOpacity onPress={blueThemeChange} style={styles.button} accessible={true} accessibilityLabel="Button"
  accessibilityRole="Blue Mode"> 
          <Text style={styles.buttonText}>Blue Mode</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={redThemeChange} style={styles.button} accessible={true} accessibilityLabel="Button"
  accessibilityRole="Red Mode">
          <Text style={styles.buttonText}>Red Mode</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={purpleThemeChange} accessible={true} style={styles.button} accessibilityLabel="Button"
  accessibilityRole="Purple Mode">
          <Text style={styles.buttonText}>Purple Mode</Text>
        </TouchableOpacity>


        <TouchableOpacity onPress={yellowThemeChange} style={styles.button} accessible={true} accessibilityLabel="Button"
  accessibilityRole="Yellow Mode">
          <Text style={styles.buttonText}>Yellow Mode</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={lightThemeChange} style={styles.button} accessible={true} accessibilityLabel="Button"
  accessibilityRole="Light Mode">
          <Text style={styles.buttonText}>Light Mode</Text>
        </TouchableOpacity>

         <TouchableOpacity onPress={darkThemeChange} style={styles.button} accessible={true}
         accessibilityLabel="Button" accessibilityRole="Dark Mode">
